...
################################################
### Prediction Without alternative car 6 ########
################################################

database<- dplyr::select(database, -c(type6, range6, fuel6,
                                      price6, speed6, acc6,
                                      size6, pollution6, space6,
                                      station6, cost6, speed6))
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="prediction"){
  ...
  ### Define settings for MNL model component
  mnl_settings    = list(
    alternatives  = c(car1=1, car2=2, car3=3, car4=4, car5=5),
    avail         = 1,
    choiceVar     = Choice,
    V             = V
  )
...
### Rerun the predictions with the new data 
...
write.csv(final,"Predictions_mxl2.csv", row.names = FALSE)
